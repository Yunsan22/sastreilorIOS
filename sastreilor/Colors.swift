...
//  sastreilor
//
//  Created by Yunior Sanchez on 1/19/23.
//
import Foundation
import UIKit
struct Colors {
    var objectsArray = [
        TableViewCellModel(
            category: "Category #1 Dashboard",
            subcategory: ["SubCategory #1.1 Take measurment", "SubCategory #1.2 ToDos"],
            colors: [
                // SubCategory #1.1
                [CollectionViewCellModel(image: UIImage(named: "measurement")!, name: "Take Measurement"),
...
//                 CollectionViewCellModel(color: UIColor.colorFromHex("#2E8B57"), name: "Sea Green")
                ...
                // SubCategory #1.2
                 [CollectionViewCellModel(image: UIImage(named: "file-check")!, name: "TO-DO"),
